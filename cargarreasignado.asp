...
if session("codusuario")<>"" then
	...
	buscador=obtener("buscador")	
		...
		<html>
			<title>Nueva Carga de Reasignados</title>
			...
			<body topmargin=0 leftmargin=0 bgcolor="#FFFFFF">
					...
					<form name=formula method=post enctype="multipart/form-data" action="uploadfilereasignado.asp">
					<tr height=20>	
						<td bgcolor="#F5F5F5" colspan=2>			
							<font size=2 color=#483d8b face=Arial><b>&nbsp;<b>Nueva Carga de Reasignados</b></b></font>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type=checkbox name="activo" style="font-size: xx-small;" checked>&nbsp;&nbsp;<font face=Arial size=2 color=#483d8b>Inactivar Reasignados Actuales</font></td>
					</tr>					
					<tr>					
						<td bgcolor="#F5F5F5"><font face=Arial size=2 color=#483d8b>&nbsp;</font></td>
						<td bgcolor="#F5F5F5" align=right height=40><%if codreasignado="" then%><a href="javascript:agregar();"><img src="imagenes/guardar.gif" border=0 alt="Guardar" title="Guardar"></a>&nbsp;<%else%><a href="javascript:modificar();"><img src="imagenes/guardar.gif" border=0 alt="Guardar" title="Guardar"></a>&nbsp;<%end if%><a href="javascript:window.close();"><img src="imagenes/salida.gif" border=0 alt="Salir" title="Salir"></a>&nbsp;</td>					
					</tr>
