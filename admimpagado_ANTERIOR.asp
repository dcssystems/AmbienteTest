...
<%Response.Flush()%>
	...
	<script language=javascript>
        ...
        if obtener("nuevabusqueda")<>"" or IsNull(RS.Fields(0)) then
            sql="EXEC SP_VERIMPAGADO '" & vistabusqueda & "','" & session("codusuariodif") & "'," & cantidadxpagina & "," & pag & ",'" & mid(fechaasigini,7,4) & mid(fechaasigini,4,2) & mid(fechaasigini,1,2) & "','" & mid(fechaasigfin,7,4) & mid(fechaasigfin,4,2) & mid(fechaasigfin,1,2) & "'," & xcontrato & "," & xcodigocentral & "," & xcodtipodocumento & "," & xnumdocumento & "," & xdiaatrasoini & "," & xdiaatrasofin & "," & xcodproducto & "," & xcodagencia & "," & xcodmarca & "," & xcodterritorio & "," & xcodoficina & "," & xfechapromesaini & "," & xfechapromesafin & "," & xcodgestion & "," & xcodgestor
            conn.execute sql
            ''response.write sql
		    ''consultar sql,RS		
		    ''RS.close
        ...
        ''sql="EXEC SP_VERIMPAGADO '" & vistabusqueda & "'," & cantidadxpagina & "," & pag & ",'" & mid(fechaasigini,7,4) & mid(fechaasigini,4,2) & mid(fechaasigini,1,2) & "','" & mid(fechaasigfin,7,4) & mid(fechaasigfin,4,2) & mid(fechaasigfin,1,2) & "',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL"
        ''response.write sql
		''consultar sql,RS
