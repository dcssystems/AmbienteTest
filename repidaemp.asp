...
if session("codusuario")<>"" then
	conectar
	if permisofacultad("repidaemp.asp") then
		...
		<!--cargando--><%Response.Flush()%><img src=imagenes/loading.gif border=0 id="imgloading" name="imgloading" style="margin-left: 50px;margin-top:50px;"><%Response.Flush()%>
			...
			<form name=formula method=post>
					...
					<tr>
						...
						<font size=4 color=#483d8b face=Arial><b>Informe Diario de Mora (IDA - BC) - Empresas al <%=fechacierre%></b></font></td>
					</tr>
					</table>
					...
					<%
                        ...
                        sql="select codterritorio,territorio,SUM(jud) as StockCierre,IsNull((select sum(ingresos) from #INGRESOS where cod_territorio=A.codterritorio),0) as INGRESOS,IsNull((select sum(salidas) from #SALIDAS where cod_territorio=A.codterritorio),0) as SALIDAS,IsNull((select sum(salidasconventa) from #SALIDAS where cod_territorio=A.codterritorio),0) as SALIDASCONVENTA,IsNull((select sum(REF) from #SALIDAS where cod_territorio=A.codterritorio),0) as REF,IsNull((select sum(TRA) from #SALIDAS where cod_territorio=A.codterritorio),0) as TRA,IsNull((select sum(EJEC) from #SALIDAS where cod_territorio=A.codterritorio),0) as EJEC,IsNull((select sum(EFE) from #SALIDAS where cod_territorio=A.codterritorio),0) as EFE,IsNull((select sum(OTRO) from #SALIDAS where cod_territorio=A.codterritorio),0) as OTRO,IsNull((select sum(Salidas) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO='BEC'),0) as BEC,IsNull((select sum(Salidas) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO='BEC-RED'),0) as BECRED,IsNull((select sum(Salidas) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO='PROMOTORES'),0) as PROMOTORES,IsNull((select sum(SalidasAAAA) from #SALIDAS where cod_territorio=A.codterritorio),0) as SalidasAAAA, " &_
                            "IsNull((select sum(SalidasAAAAConVenta) from #SALIDAS where cod_territorio=A.codterritorio),0) as SalidasAAAAConVenta, " &_
                            " IsNull((select sum(meta) from FB.CentroCobranzas.dbo.Metas_IDA where SEGMENTO in ('BEC','BEC-RED','PROMOTORES') and codterritorio=A.codterritorio),0) as MetaMes  " & _
                            "from FB.CentroCobranzas.dbo.PD_Casos_Jud A where SEGMENTO_RIESGO in ('BEC','BEC-RED','PROMOTORES') and fechadatos=(select MAX(fechacierre) from FB.CentroCobranzas.dbo.PD_FechasCierre where fechacierre<'" & mid(fechacierre,7,4) & mid(fechacierre,4,2) & mid(fechacierre,1,2) & "') group by codterritorio,territorio order by StockCierre desc"
                        bgcolor="#FFFFFF"
                        consultar sql,RS	
                        ...
                        <tr>
	                        <td bgcolor="<%=bgcolor%>">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=RS.Fields("TERRITORIO")%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("StockCierre")/1000,0)%></font></a>
	                        </td>						
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("Ingresos")/1000,0)%></font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("MetaMes")/1000,0)%></font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("MetaMes")*12/1000,0)%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasAAAAConVenta")/1000,0)%></font></a>
	                        </td>		                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasAAAA")/1000,0)%></font></a>
	                        </td>	                        						                        	                        
						    <td bgcolor="<%=bgcolor%>" align="right" width="4%">
							    <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(iif(RS.Fields("MetaMes")>0,iif(RS.Fields("SalidasAAAA")>0,RS.Fields("SalidasAAAA")*100/iif(RS.Fields("MetaMes")>0,RS.Fields("MetaMes")*12,1),0),0),2)%>%</font></a>
						    </td>	
						    ...
						    <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasConVenta")/1000,0)%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("Salidas")/1000,0)%></font></a>
	                        </td>	                        						                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
	                        ...
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("REF")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("TRA")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("EJEC")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("EFE")/1000,0)%></font></a>
	                        </td>	 	                        	                        	                        	                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("OTRO")/1000,0)%></font></a>
	                        </td>	 	                        	 
						    <td bgcolor="#FFFFFF" align="center" width="1%">
							    <font size=1 color=#FFFFFF face=Arial><b>&nbsp;</b></font>
						    </td>	                                               	                        	                        	                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=particulares&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("BEC")/1000,0)%></font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=pyme&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("BECRED")/1000,0)%></font></a>
	                        </td>		                
	                        <td bgcolor="<%=bgcolor%>" align="right" width="4%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidaemp.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=pyme&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("PROMOTORES")/1000,0)%></font></a>
	                        </td>		                	                                	                        
                        </tr>	                        
                        <%
                        ...
                        SUMA_PROMOTORES=SUMA_PROMOTORES + RS.Fields("PROMOTORES")/1000
                        ...
                        <tr>
						    ...
						    <td bgcolor="#007DC5" align="right" width="4%">
						    ...
						    <td bgcolor="#007DC5" align="right" width="4%">
							    <font size=1 color=#FFFFFF face=Arial><b><%=FormatNumber(SUMA_PROMOTORES,0)%></b></font>
						    </td>						    											
					    </tr>					    
					</table>
