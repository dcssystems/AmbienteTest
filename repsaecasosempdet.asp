...
if session("codusuario")<>"" then
	...
	if permisofacultad("repsaeestudioemp.asp") or permisofacultad("repsaeterritorioemp.asp") or permisofacultad("repsaegestoremp.asp")  or permisofacultad("repsaecasosempdet.asp") or permisofacultad("repidaemp.asp") or permisofacultad("repidasegmentoemp.asp") or permisofacultad("repidaestudioemp.asp") then
        ...
        filtrobuscador = ""
        filtrobuscador = " where A.segmento_riesgo in ('BEC','BEC-RED','CIB','PROMOTORES') "
...
<head>
<title>SAE - Resumen de Casos - Empresas</title>
...
<form name=formula method=post action="repsaecasosempdet.asp">
...
<tr>	
	...
	<td bgcolor="#F5F5F5" align="left">			
		<font size=4 color=#483d8b face=Arial>&nbsp;&nbsp;<b>SAE - Resumen de Casos - Empresas al <%=fechacierre%></b></font>
	</td>
</tr>
</table>
