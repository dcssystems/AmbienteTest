...
if session("codusuario")<>"" then
	conectar
	if permisofacultad("repidasegmentoprom.asp") then
		...
		<html>
			...
			<form name=formula method=post>
					...
					<tr>
						...
						<font size=4 color=#483d8b face=Arial><b>Informe Diario de Mora (IDA - BC) al <%=fechacierre%> - PROMOTORES</b></font></td>
					</tr>
					</table>
					...
					<%
                        ...
                        <tr>
	                        <td bgcolor="<%=bgcolor%>">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=RS.Fields("Especialista") & " (" & RS.Fields("TERRITORIO") & ")"%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("StockCierre")/1000,0)%></font></a>
	                        </td>						
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("Ingresos")/1000,0)%></font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("MetaMes")/1000,0)%></font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("MetaMes")*12/1000,0)%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasAAAAConVenta")/1000,0)%></font></a>
	                        </td>		                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasAAAA")/1000,0)%></font></a>
	                        </td>	                        						                        	                        
						    <td bgcolor="<%=bgcolor%>" align="right" width="5%">
							    <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(iif(RS.Fields("MetaMes")>0,iif(RS.Fields("SalidasAAAA")>0,RS.Fields("SalidasAAAA")*100/iif(RS.Fields("MetaMes")>0,RS.Fields("MetaMes")*12,1),0),0),2)%>%</font></a>
						    </td>	
						    ...
						    <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasConVenta")/1000,0)%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("Salidas")/1000,0)%></font></a>
	                        </td>	                        						                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
	                        ...
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("REF")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("TRA")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("EJEC")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("EFE")/1000,0)%></font></a>
	                        </td>	 	                        	                        	                        	                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("OTRO")/1000,0)%></font></a>
	                        </td>	 	                        	 
						    <td bgcolor="#FFFFFF" align="center" width="1%">
							    <font size=1 color=#FFFFFF face=Arial><b>&nbsp;</b></font>
						    </td>	                                               	                        	                        	                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosempdet.asp?paginapadre=repidasegmentoprom.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=PROMOTORES&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("PROM")/1000,0)%></font></a>
	                        </td>		                        	                        
                        </tr>	                        
                        <%
                        ...
                        SUMA_PROM=SUMA_PROM + RS.Fields("PROM")/1000
