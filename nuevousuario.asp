	...
	codusuario=obtener("codusuario")
		...
		<html>
			...
			<body topmargin=0 leftmargin=0 bgcolor="#FFFFFF">
					...
					<tr>
						<td bgcolor="#f5f5f5"><font face=Arial size=2 color=#483d8b>&nbsp;&nbsp;Contraseña:</font></td>
					...
					<td>
						...
						<%
						if codusuario<>"" then
							''esto es para que si anteriormente había un tipo de usuario inactivo se muestre
