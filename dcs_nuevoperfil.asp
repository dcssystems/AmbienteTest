	...
	codperfil=obtener("codperfil")
		...
		<link rel="stylesheet" href="assets/css/css/animation.css"/>
			...
			<body topmargin=0 leftmargin=0 bgcolor="#FFFFFF">
					...
					<%if fechaReg<>"" then%>
					<tr height=20>
						<td colspan=2 align=right><font  size=1 >Registró:&nbsp;<b><%=usuarioReg%>&nbsp;el&nbsp;<%=fechaReg%></b>
							...
							<table width=90% align=center cellpadding=0 cellspacing=0 border=0>
									...
									consultar sql,RS
										...
										Do While Not RS.EOF
											...
											'	cadenagrupofacultad=cadenagrupofacultad & "<tr " & intercalacolor & "><td valign=top rowspan=numfilas><font  size=1 color=#483d8b>&nbsp;&nbsp;<b>" & GrupoFactultad & "</b></font></td><td><input type=checkbox name='codfact" & RS.Fields("CodFacultad") & "' style='font-size: xx-small;' " & iif(IsNull(RS.Fields("codperfil")),"","checked") & "><font  size=1 color=#483d8b>" & RS.Fields("Facultad") & "</font></td></tr>" & chr(10)
