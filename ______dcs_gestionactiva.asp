...
if session("codusuario")<>"" then
		...
		if idcamperacc = "" and idgestion = "" and comentario = "" and codtipocontacto = "" then
			...
			'if externo = 0 then
				...
				'	"WHERE vlog.phone_number = " & DTELEFONO & " " & chr(10) & _
					     ...
					     "VALUES" & chr(10) & _
					      "(GETDATE() " & chr(10) & _
							   ...
							   '",'" & uniqueid & "'"  & chr(10) & _   		
								'"," & 	lead_id & chr(10) & _ 
								'"," & 	list_id & chr(10) & _   
								'",'" & 	campaign_id & "'"  & chr(10) & _ 
								'",'" & 	call_date   & "'"  & chr(10) & _ 
								'"," & 	start_epoch  & chr(10) & _  
								'"," & 	end_epoch     & chr(10) & _ 
								'"," & 	length_in_sec  & chr(10) & _ 
								'",'" & 	phone_number & "'"  & chr(10) & _ 
								'",'" & 	uuser       & "'"  & chr(10) & _ 
								'"," & 	called_count  & chr(10) & _ 
								'",'" & 	filename    & "'"  & chr(10) & _ 
								'",'" & 	server_ip& "')"				          
			...
			' end if
				...
				'if comentario <> "" and codtipocontacto <> "" and idcamperacc <> "" then								
							...
							' sqlU="UPDATE Campaña_Persona_Accion" & chr(10) & _
								...
								' "WHERE IDCampañaPersonaAccion = " & idcamperacc  & " AND " & chr(10) & _
								' "IDGestion = " & idgestion
					        ...
					        ' conn.Execute sqlU
								...
								'message = iif(tpress != "" , tpress , "En espera")
