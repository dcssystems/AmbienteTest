      ...
      function toggleCodes(on) {
		...
		<script language="javascript">
		  ...
		  //Configuración general de datos de tabla 0
		    ...
		    cabecera[tabla] = new Array('C&oacute;digo','Descripci&oacute;n','Orden','Editar');
		    identificadorfilas[tabla]="fila";
		    pievisible[tabla]=true;
		    columnavisible[tabla] = new Array( true, true, true, true);
		    anchocolumna[tabla] =  new Array(  '8%' , '15%' , '4%','');
		    aligncabecera[tabla] = new Array('left','left','left','left');
		    aligndetalle[tabla] = new Array('right','left','left','left');
		...
		<%if contador=0 then%>
			...
			<tr class="fondo-orange">
				<td class="text-orange" width="250"sss><font size="2" face="Raleway"><b>Grupo Privilegio (0) - No hay registros.</b></font>&nbsp;<a href="javascript:agregar();"><i class="demo-icon icon-doc">&#xe808;</i></a></td>
		...
		%>
			...
			<form name="formula" method="post">
				<table width="100%" cellpadding="4" cellspacing="0" border="0">		
					<tr class="fondo-orange">
						<td class="text-orange" align="left" width="250"><font size="2" face="Raleway"><b>Grupo Privilegio (<%=contadortotal%>)&nbsp;&nbsp;<a href="javascript:actualizar();"><i class="demo-icon icon-floppy">&#xe809;</i></a>&nbsp;&nbsp;<a href="javascript:agregar();"><i class="demo-icon icon-doc">&#xe808;</i></a>&nbsp;&nbsp;<a href="javascript:exportar();"><i class="demo-icon icon-file-excel">&#xf1c3;</i></a><!--&nbsp;&nbsp;<a href="javascript:imprimir();"><img src="imagenes/imprimir.gif" border=0 alt="Imprimir" title="Imprimir" align=middle></a>--><%if expimp="1" then%>&nbsp;&nbsp;<a href='<%=RutaWebExportar%>/UserExport<%=session("codusuario")%>.xls?time=<%=tiempoexport%>','_self'><i class="demo-icon icon-download">&#xe814;</i></a><%end if%></b></font></td>
