	...
	%>
		...
		<script language=javascript>
		  ...
		  //Configuración general de datos de tabla 0
		    ...
		    anchocolumna[tabla] =  new Array( '2%', '3%', '15%' , '7%' ,'3%', '10%', '8%' , '' ,'4%','4%','4%');
