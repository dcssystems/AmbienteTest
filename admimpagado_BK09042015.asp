				...
				if expimp="1" then
	               ...
	               '' consultar sql,RS
                    ...
                    sql="select convert(varchar,DD.FechaGestion,103) AS FechaAsig, " &_
                        ...
                        "left outer join Ubigeo UBI2 on DD.codestado=UBI2.coddpto and DD.coddistrito=UBI2.coddist and DD.codprovincia=UBI2.codprov " & filtrobuscador & " order by DD.Nro"
		            conn.execute sql                 
                   ...
                   '' RS.Close
                    ...
                    consulta_exp="select A.* " & _
								 "from tempdb.dbo.##Userexp" & session("codusuariodif") & " A "
