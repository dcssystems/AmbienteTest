...
sql="select Linea,nro " & _
	...
	%>
			...
			<tr>
				<td bgcolor="#dcdcdc" height=100% valign=top>
					<OBJECT name="DCube1" id="DCube1" style="WIDTH: 100%; HEIGHT:100%;" classid="clsid:6D63F73D-3688-3000-9C0F-00A0C90F29FC" >
						...
						<PARAM NAME="CubeBackColor" VALUE="14215689">
						<PARAM NAME="FooterBackColor" VALUE="0">
						<PARAM NAME="FooterForeColor" VALUE="1">
		...
		function inicio(){
			...
			xmlDoc.load("imagenes/repimpaglobal<%=session("codusuario")%>.xml");
		}
		function checkState(){
			var returnString;
			var readyState;
		...
		function FillCube(){
			...
			thisField=DCube1.Fields.Add('Unidad', 'unity', DCRow).GroupFooterVisible = false;
			thisField=DCube1.Fields.Add('PrecioSoles', 'Precio S/.', DCRow).GroupFooterVisible = false;
			thisField=DCube1.Fields.Add('FechaAAAA','Year', DCColumn);
