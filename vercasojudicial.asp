...
if session("codusuario")<>"" then
	conectar
	if permisofacultad("repsaeestudio.asp") or permisofacultad("repsaeterritorio.asp") or permisofacultad("repsaegestor.asp")  or permisofacultad("repsaecasosdet.asp") or permisofacultad("repida.asp") or permisofacultad("repidasegmento.asp") or permisofacultad("repidasegmentopart.asp") or permisofacultad("repidaestudio.asp") or permisofacultad("repsaeestudioemp.asp") or permisofacultad("repsaeterritorioemp.asp") or permisofacultad("repsaegestoremp.asp")  or permisofacultad("repsaecasosempdet.asp") or permisofacultad("repidaemp.asp") or permisofacultad("repidasegmentoemp.asp") or permisofacultad("repidaestudioemp.asp") then
			...
			<tr>
				 ...
				 <td colspan=3>
                        <%
                            ...
                            sql="select distinct b.fiador as CodigoCentral, " &_
		                                    ...
		                                    "A.FECHADATOS, C.dirprin AS direccion, C.desdistr As distrito, C.desprovi AS provincia, C.desdpto as departamento, C.email " &_
                                    "from FB.CentroCobranzas.dbo.XCOM_CRDT000_Datos_Generales A  " &_
                                ...
                                %>  
								            <table width=100% cellpadding=0 cellspacing=2 border=0>
								        	    <tr>
								        	        ...
								        	        <td bgcolor="#BEE8FB"><font size=2 face=Arial color=#00529B><b>Dirección</b></font></td>
								        	        <td bgcolor="#BEE8FB"><font size=2 face=Arial color=#00529B><b>Email</b></font></td>
								        	    </tr>
								        	    <%do while not RS1.EOF%>
								        	    <tr>
								        	        ...
								        	        <td bgcolor="#E9F8FE"><font size=2 face=Arial color=#00529B><%if RS1.Fields("direccion") <>"" then%><%=RS1.Fields("direccion") & " - " & RS1.Fields("distrito")& " - " & RS1.Fields("provincia")& " - " & RS1.Fields("departamento") %><%else%>&nbsp;<%end if %></font></td>
								        	        <td bgcolor="#E9F8FE"><font size=2 face=Arial color=#00529B><%=RS1.Fields("email")%></font></td>
								        	    </tr>				
								        	    <%
								        	    RS1.movenext
								        	    loop%>				        	    
