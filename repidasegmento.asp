...
if session("codusuario")<>"" then
	conectar
	if permisofacultad("repidasegmento.asp") then
		...
		<html>
			...
			<form name=formula method=post>
					...
					<tr>
						...
						<font size=4 color=#483d8b face=Arial><b>Informe Diario de Mora (IDA - BC) al <%=fechacierre%> - PYME</b></font></td>
					</tr>
					</table>
					...
					<%
                        ...
                        sql="select codterritorio,territorio,especialista,SUM(jud) as StockCierre,IsNull((select sum(ingresos) from #INGRESOS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as INGRESOS,IsNull((select sum(salidas) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as SALIDAS,IsNull((select sum(salidasconventa) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as SALIDASCONVENTA,IsNull((select sum(REF) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as REF,IsNull((select sum(TRA) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as TRA,IsNull((select sum(EJEC) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as EJEC,IsNull((select sum(EFE) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as EFE,IsNull((select sum(OTRO) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as OTRO,0 as PART,IsNull((select sum(Salidas) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as PYME,IsNull((select sum(SalidasAAAA) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as SalidasAAAA,IsNull((select sum(SalidasAAAAConVenta) from #SALIDAS where cod_territorio=A.codterritorio and SEGMENTO_RIESGO=A.segmento_riesgo and ESPECIALISTA_JUD_PYME=A.Especialista),0) as SalidasAAAAConVenta, " &_
                        ...
                        <tr>
	                        <td bgcolor="<%=bgcolor%>">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=RS.Fields("Especialista") & " (" & RS.Fields("TERRITORIO") & ")"%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("StockCierre")/1000,0)%></font></a>
	                        </td>						
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("Ingresos")/1000,0)%></font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("MetaMes")/1000,0)%></font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("MetaMes")*12/1000,0)%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasAAAAConVenta")/1000,0)%></font></a>
	                        </td>		                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasAAAA")/1000,0)%></font></a>
	                        </td>	                        						                        	                        
						    <td bgcolor="<%=bgcolor%>" align="right" width="5%">
							    <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(iif(RS.Fields("MetaMes")>0,iif(RS.Fields("SalidasAAAA")>0,RS.Fields("SalidasAAAA")*100/iif(RS.Fields("MetaMes")>0,RS.Fields("MetaMes")*12,1),0),0),2)%>%</font></a>
						    </td>	
						    <!--<td bgcolor="<%=bgcolor%>" align="center" width="15"><a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><img src="imagenes/<%=iif(iif(RS.Fields("MetaMes")>0,iif(RS.Fields("SalidasAAAA")>0,RS.Fields("SalidasAAAA")*100/iif(RS.Fields("MetaMes")>0,RS.Fields("MetaMes")*12,1),0),0)>=90,"sem_verde",iif(iif(RS.Fields("MetaMes")>0,iif(RS.Fields("SalidasAAAA")>0,RS.Fields("SalidasAAAA")*100/iif(RS.Fields("MetaMes")>0,RS.Fields("MetaMes")*12,1),0),0)>=80,"sem_amarillo","sem_rojo"))%>.png" title="<%=iif(iif(RS.Fields("MetaMes")>0,iif(RS.Fields("SalidasAAAA")>0,RS.Fields("SalidasAAAA")*100/iif(RS.Fields("MetaMes")>0,RS.Fields("MetaMes")*12,1),0),0)>=90,"[90%-100%]",iif(iif(RS.Fields("MetaMes")>0,iif(RS.Fields("SalidasAAAA")>0,RS.Fields("SalidasAAAA")*100/iif(RS.Fields("MetaMes")>0,RS.Fields("MetaMes")*12,1),0),0)>=80,"[80%-90%]","[0%-80&gt;"))%>" alt="<%=iif(iif(RS.Fields("MetaMes")>0,iif(RS.Fields("SalidasAAAA")>0,RS.Fields("SalidasAAAA")*100/iif(RS.Fields("MetaMes")>0,RS.Fields("MetaMes")*12,1),0),0)>=90,"[90%-100%]",iif(iif(RS.Fields("MetaMes")>0,iif(RS.Fields("SalidasAAAA")>0,RS.Fields("SalidasAAAA")*100/iif(RS.Fields("MetaMes")>0,RS.Fields("MetaMes")*12,1),0),0)>=80,"[80%-90%]","[0%-80&gt;"))%>" width="12" border=0></a></td>-->
						    <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasConVenta")/1000,0)%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("Salidas")/1000,0)%></font></a>
	                        </td>	                        						                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
	                        ...
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("REF")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("TRA")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("EJEC")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("EFE")/1000,0)%></font></a>
	                        </td>	 	                        	                        	                        	                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("OTRO")/1000,0)%></font></a>
	                        </td>	 	                        	 
						    <td bgcolor="#FFFFFF" align="center" width="1%">
							    <font size=1 color=#FFFFFF face=Arial><b>&nbsp;</b></font>
						    </td>	                                               	                        	                        	                        
	                        <!--<td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=particulares&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("PART")/1000,0)%></font></a>
	                        </td>	-->
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidasegmento.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=<%=RS.Fields("CODTERRITORIO")%>&plaza=&segmento=pyme&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("PYME")/1000,0)%></font></a>
	                        </td>		                        	                        
                        </tr>	                        
                        <%
