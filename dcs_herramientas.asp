      ...
      function toggleCodes(on) {
		...
		<script type="text/javascript">
		    ...
		    function modificarclave() {
		        ventanaclave = global_popup_IWTSystem(ventanaclave, "dcs_modificarclave.asp", "NewClave", "scrollbars=yes,scrolling=yes,top=" + (screen.height / 4 - 30) + ",height=170,width=450,left=" + ((screen.width - 400) / 2) + ",resizable=yes");
		    }
		</script>
		</head>
