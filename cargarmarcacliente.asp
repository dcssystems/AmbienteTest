...
if session("codusuario")<>"" then
	...
	buscador=obtener("buscador")	
		...
		<html>
			<title>Nueva Carga de Marca Clientess</title>
			...
			<body topmargin=0 leftmargin=0 bgcolor="#FFFFFF">
					...
					<form name=formula method=post enctype="multipart/form-data" action="uploadfilemarcacliente.asp">
					<tr height=20>	
						<td bgcolor="#F5F5F5" colspan=2>			
							<font size=2 color=#483d8b face=Arial><b>&nbsp;<b>Nueva Carga de Marca Clientes</b></b></font>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type=checkbox name="activo" style="font-size: xx-small;" checked>&nbsp;&nbsp;<font face=Arial size=2 color=#483d8b>Inactivar Marca Clientes Actuales</font></td>
					</tr>					
					<tr>					
