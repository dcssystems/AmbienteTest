...
if session("codusuario")<>"" then
	conectar
	if permisofacultad("repidaestudio.asp") then
		
	    fechacierre=obtener("fechacierre")
	    ''if not IsDate(fechacierre) then
	    if fechacierre="" then
            sql="select max(fechadatos) as fechadatos from FB.CentroCobranzas.dbo.XCOM_SAEDTASI_HOY"
            consultar sql,RS	
		...
		<html>
			...
			<form name=formula method=post>
					...
					<tr>
						...
						<font size=4 color=#483d8b face=Arial><b>Informe Diario de Mora (IDA - BC) al <%=fechacierre%> - ESTUDIOS</b></font></td>
					</tr>
					</table>
					...
					<tr>
						...
						<td bgcolor="#007DC5" align="center" width="5%">
							<font size=1 color=#FFFFFF face=Arial><b>Avance c/ Venta %</b></font>
						</td>	
						<td bgcolor="#007DC5" align="center" width="5%">
							<font size=1 color=#FFFFFF face=Arial><b>Avance s/ Venta %</b></font>
						</td>
					...
					<%
                        ...
                        sql="SELECT	" &_
			                "IsNull(C.estudio,'NO IDENTIFICADO') as estudio, " &_
		                ...
		                "GROUP BY IsNull(C.estudio,'NO IDENTIFICADO'), " &_
                        ...
                        sql="select estudio,SUM(jud) as StockCierre, " &_
                            ...
                            "IsNull((select sum(Salidas) from #SALIDAS where estudio=A.estudio and SEGMENTO_RIESGO='PARTICULARES'),0) as PART, " &_
                            "IsNull((select sum(Salidas) from #SALIDAS where estudio=A.estudio and SEGMENTO_RIESGO='PYME'),0) as PYME, " &_
                            ...
                            "from FB.CentroCobranzas.dbo.PD_Casos_Jud A where fechadatos=(select MAX(fechacierre) from FB.CentroCobranzas.dbo.PD_FechasCierre where fechacierre<'" & mid(fechacierre,7,4) & mid(fechacierre,4,2) & mid(fechacierre,1,2) & "') group by estudio order by StockCierre desc"
                        bgcolor="#FFFFFF"
                        ''response.Write sql
                        consultar sql,RS	
                        ...
                        <tr>
	                        <td bgcolor="<%=bgcolor%>">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=RS.Fields("Estudio")%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("StockCierre")/1000,0)%></font></a>
	                        </td>						
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("Ingresos")/1000,0)%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasAAAAConVenta")/1000,0)%></font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasAAAA")/1000,0)%></font></a>
	                        </td>
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("SalidasConVenta")/1000,0)%></font></a>
	                        </td>	                        						                        	                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("Salidas")/1000,0)%></font></a>
	                        </td>
	                        ...
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("REF")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("TRA")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("EJEC")/1000,0)%></font></a>
	                        </td>	 
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("EFE")/1000,0)%></font></a>
	                        </td>	 	                        	                        	                        	                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("OTRO")/1000,0)%></font></a>
	                        </td>	 	                        	 
						    <td bgcolor="#FFFFFF" align="center" width="1%">
							    <font size=1 color=#FFFFFF face=Arial><b>&nbsp;</b></font>
						    </td>	                                               	                        	                        	                        
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=particulares&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("PART")/1000,0)%></font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=pyme&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(RS.Fields("PYME")/1000,0)%></font></a>
	                        </td>	
						    <td bgcolor="#FFFFFF" align="center" width="1%">
							    <font size=1 color=#FFFFFF face=Arial><b>&nbsp;</b></font>
						    </td>
						    <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=particulares&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(iif(RS.Fields("StockCierre")+RS.Fields("Ingresos")>0,RS.Fields("SalidasConVenta")*100/(RS.Fields("StockCierre")+RS.Fields("Ingresos")),0),2)%>%</font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="right" width="5%">
		                        <a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=particulares&confase="><font size=1 color=#483d8b face=Arial><%=FormatNumber(iif(RS.Fields("StockCierre")+RS.Fields("Ingresos")>0,RS.Fields("Salidas")*100/(RS.Fields("StockCierre")+RS.Fields("Ingresos")),0),2)%>%</font></a>
	                        </td>	
	                        <td bgcolor="<%=bgcolor%>" align="center" width=15><a href="repsaecasosdet.asp?paginapadre=repidaestudio.asp&asignado=&fechacierre=<%=fechacierre%>&codterritorio=&plaza=&segmento=particulares&confase="><img src="imagenes/<%=iif(iif(RS.Fields("StockCierre")+RS.Fields("Ingresos")>0,RS.Fields("Salidas")*100/(RS.Fields("StockCierre")+RS.Fields("Ingresos")),0)>=90,"sem_verde",iif(iif(RS.Fields("StockCierre")+RS.Fields("Ingresos")>0,RS.Fields("Salidas")*100/(RS.Fields("StockCierre")+RS.Fields("Ingresos")),0)>=80,"sem_amarillo","sem_rojo"))%>.png" title="<%=iif(iif(RS.Fields("StockCierre")+RS.Fields("Ingresos")>0,RS.Fields("Salidas")*100/(RS.Fields("StockCierre")+RS.Fields("Ingresos")),0)>=90,"[90%-100%]",iif(iif(RS.Fields("StockCierre")+RS.Fields("Ingresos")>0,RS.Fields("Salidas")*100/(RS.Fields("StockCierre")+RS.Fields("Ingresos")),0)>=80,"[80%-90%]","[0%-80&gt;"))%>" alt="<%=iif(iif(RS.Fields("StockCierre")+RS.Fields("Ingresos")>0,RS.Fields("Salidas")*100/(RS.Fields("StockCierre")+RS.Fields("Ingresos")),0)>=90,"[90%-100%]",iif(iif(RS.Fields("StockCierre")+RS.Fields("Ingresos")>0,RS.Fields("Salidas")*100/(RS.Fields("StockCierre")+RS.Fields("Ingresos")),0)>=80,"[80%-90%]","[0%-80&gt;"))%>" width="12" border=0></a></td>				                            	                        	                        
                        </tr>	                        
                        <%
