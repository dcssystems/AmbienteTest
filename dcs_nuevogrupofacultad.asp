			...
			<body topmargin=0 leftmargin=0 bgcolor="#FFFFFF">
					...
					<tr>	
						<td bgcolor="#F5F5F5" colspan=2>			
							<font size=2 color=#483d8b face=Arial><b>&nbsp;<b><%if codgrupofacultad="" then%>Nuevo <%end if%>Grupo Facultad</b></b></font>
						</td>
					</tr>
					<%if fechaReg<>"" then%>
					<tr height=20>
					...
					<tr>
						<td width=20%><font face=Arial size=2 color=#483d8b>&nbsp;&nbsp;Orden:</font></td>
					...
					<tr>					
						...
						<td bgcolor="#F5F5F5" align=right height=40><%if codgrupofacultad="" then%><a href="javascript:agregar();"><img src="imagenes/guardar.gif" border=0 alt="Guardar" title="Guardar"></a>&nbsp;<%else%><a href="javascript:modificar();"><img src="imagenes/guardar.gif" border=0 alt="Guardar" title="Guardar"></a>&nbsp;<%end if%><a href="javascript:window.close();"><img src="imagenes/salida.gif" border=0 alt="Salir" title="Salir"></a>&nbsp;</td>					
					</tr>
