...
<%Response.Flush()%>
	...
	<script language=javascript>
		...
		if fechapromesaini<>"" and fechapromesafin<>"" then
			filtrobuscador = filtrobuscador & " and RG.fechapromesa between '" & mid(fechapromesaini,7,4) & mid(fechapromesaini,4,2) & mid(fechapromesaini,1,2) & "' and '" & mid(fechapromesafin,7,4) & mid(fechapromesafin,4,2) & mid(fechapromesafin,1,2) & "'"
		end if												
		if fechapromesaini<>"" and fechapromesafin="" then
			filtrobuscador = filtrobuscador & " and RG.fechapromesa>='" & mid(fechapromesaini,7,4) & mid(fechapromesaini,4,2) & mid(fechapromesaini,1,2) & "' and '" & mid(fechapromesaini,7,4) & mid(fechapromesaini,4,2) & mid(fechapromesaini,1,2) & "'"
		end if														
		if fechapromesaini="" and fechapromesafin<>"" then
			filtrobuscador = filtrobuscador & " and RG.fechapromesa<='" & mid(fechapromesafin,7,4) & mid(fechapromesafin,4,2) & mid(fechapromesafin,1,2) & "'"
		end if																
		if codgestion<>"" then
  ...
  <td colspan="17">
		...
		''Si se pide exportar a excel
				if expimp="1" then
				    ...
				    ''sql="select OBJECT_ID('tempdb.dbo.##Userexp" & session("codusuariodif") & "')"
	               '' consultar sql,RS
