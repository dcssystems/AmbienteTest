	...
	rs.close
		...
		function showCalendar(id, format, showsTime, showsOtherMonths) {
		  ...
		  return false;
			...
			<title>Nueva Carga de emails</title>
			...
			<body topmargin=0 leftmargin=0 bgcolor="#FFFFFF">
					...
					<form name=formula method=post enctype="multipart/form-data" action="uploadfileemail.asp">
					<tr>	
						<td bgcolor="#F5F5F5" colspan=3>			
							<font size=2 color=#483d8b face=Arial><b>&nbsp;Carga de Emails</b></font>
						</td>
					</tr>
					<!--<tr>
